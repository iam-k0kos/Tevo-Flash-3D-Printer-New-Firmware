...
* Тесты и копию и действия с принтером можно сделать через "Printrun" под Windows.
...
## После прошивки (опционально, не обязательно)
1. Сделайте M502 (сброс к дефолтам) → M500 (сохранить) — на всякий случай, чтобы EEPROM был чистым.
   Выполните G28 (хоуминг).
2. Вручную введите M206 X12 Y0 Z0, затем M500 — чтобы восстановить это смещение.
3. Проверьте M503 — сверьте с таблицей из копии и с этим офсетом.
4. Всё остальное (PID, шаги, ускорения) уже зашито в прошивку по умолчанию, восстанавливать вручную не нужно.

## Мой принтер
Стоковый Tevo Flash по электрике, установлена подсветка стола, по X и Y установлены рельсы с каретками, драйверы TMC2208, мотор Z оси один, экструдер один.
